...
**Project**: device-status-manager 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a tool to manage a list of hardware devices, where the user sees their connection status, installed services and their versions. There should also be a feature to upgrade a service on a device to the latest version. 
...
```sh
git clone https://github.com/GPT-Engineer-App/device-status-manager.git
cd device-status-manager
npm i
